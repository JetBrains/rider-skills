...
All tools are invoked through `execute_tool(command="<tool> --flag value ...")` in `ue-test-authoring-v4`. Do not call underlying `mcp__<prefix>__<tool>` handles directly.

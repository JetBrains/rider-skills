...
3. Start a Rider build only after changed-file diagnostics are clean. Do not start or keep polling a build while `get_file_problems` or `lint_files` still reports errors in changed files.

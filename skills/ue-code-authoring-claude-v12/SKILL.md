---
name: ue-code-authoring-claude-v12
...
3. Expect **under ~10 polls for a normal build**. If you pass ~20, stop polling and report the build
   as not converging rather than continuing to watch it.

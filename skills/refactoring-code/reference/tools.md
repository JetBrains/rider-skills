...
- [extract_method](tools/extract_method.md) — Extract a method from a range of statements (C# only).
...
- [rename_refactoring](tools/rename_refactoring.md) — Rename a symbol declared in the given file and all its usages across the solution, or analyze the rename without mutating files (preview=true).

...
| **Console / UE Python API** | launch/restart editor, AgentBridge, per-module console vars | console/launch-exec.md, console/_index.md, console/ai/ console/animation/ console/audio/ console/core/, console/editor/ console/effects/ console/geometry/ console/interchange/, console/landscape/ console/mass/ console/materials/ console/media/, console/metahuman/ console/misc/ |
...
| **Debugger** | crash sessions, breakpoints, UE crash anatomy | debugger/diagnostic-workflows.md, debugger/crash-patterns.md, debugger/console-commands.md |

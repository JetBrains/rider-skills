...
execute_tool(command="get_file_problems --filePath Source/LyraGameTests/Private/LyraHealthTests.cpp --errorsOnly false")
execute_tool(command="lint_files --files '[\"Source/LyraGameTests/Private/FooTests.cpp\"]' --min_severity error")
execute_tool(command="reformat_file --files '[\"Source/LyraGameTests/Private/FooTests.cpp\"]'")
execute_tool(command="build_solution_start --filesToRebuild '[\"Source/LyraGameTests/Private/FooTests.cpp\"]'")
```
